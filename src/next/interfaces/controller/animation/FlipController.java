...
public class FlipController extends GitXTableController {

	public FlipController(final XController invokerController) {
	...
	public String getGitPath() {
		return "/controller/animation/FlipController";
	}
