...
public class SlideUpDownController extends GitXTableController {

	public SlideUpDownController(String title, final boolean isUp) {
		...
		getNavigationBar().getLeftButton().addClickHandler(new ClickHandler() {
			public void onClick(ClickEvent event) {
				if (isUp) {
					SlideUpDownController.this.slideUpReverse();

				} else {
					SlideUpDownController.this.slideDownReverse();
				}
			}
		});
	...
	public String getGitPath() {
		return "/controller/animation/SlideUpDownController";
	}
